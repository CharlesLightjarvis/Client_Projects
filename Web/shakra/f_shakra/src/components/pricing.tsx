...
export function Pricing({
  ...
  return (
    <div className=" max-w-5xl mx-auto px-4 border-t py-20">
      <div className="text-center space-y-6 mb-16">
        <div className="relative">
          <h2 className="text-4xl md:text-5xl font-bold font-handwritten text-zinc-900 dark:text-white rotate-1">
            {title}
        ...
        <p className="font-handwritten text-xl text-zinc-600 dark:text-zinc-400 rotate-1">
          {description}
        </p>
      </div>
