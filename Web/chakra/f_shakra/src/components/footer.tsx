  ...
  return (
    <section className={cn('relative w-full mt-0 overflow-hidden', className)}>
      <footer className="border-t bg-background mt-20 relative">
        ...
        <div
          className="bg-linear-to-b from-foreground/20 via-foreground/10 to-transparent bg-clip-text text-transparent leading-none absolute left-1/2 -translate-x-1/2 bottom-40 md:bottom-32 font-extrabold tracking-tighter pointer-events-none select-none text-center px-4"
          style={{
